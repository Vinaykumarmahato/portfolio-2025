...
const socialLinks = [
    ...
    { name: "Instagram", icon: <Instagram />, url: "https://www.instagram.com/vinay_kumar_mahato", color: "#c13584" },
    { name: "Facebook", icon: <Facebook />, url: "https://facebook.com", color: "#1877f2" },
    { name: "Topmate", icon: <span style={{ fontSize: '1.2rem' }}>🤝</span>, url: "https://topmate.io/", color: "#00aaff" },
    { name: "Email", icon: <Mail />, url: "mailto:vinay@example.com", color: "#ea4335" }
];
